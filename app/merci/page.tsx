  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      >
        ...
        <motion.div
          className="bg-gradient-to-r from-slate-700 to-slate-600 text-white p-8 text-center"
        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-gray-900">07 61 44 21 03</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-gray-900">contact@orossa-design.fr</p>
          ...
          >
            <Link href="/" className="flex-1">
              <Button className="w-full bg-slate-700 hover:bg-slate-600 text-white py-3 font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
