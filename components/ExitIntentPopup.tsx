        ...
        <div className="relative bg-gradient-to-r from-blue-700 to-blue-600 text-white p-6 rounded-t-2xl">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-blue-100">Obtenez votre devis gratuit maintenant</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600 text-sm">
              Notre équipe de 2 à 5 collaborateurs spécialisés en menuiserie bois haut de gamme vous rappelle sous 24h.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-700 focus:border-transparent transition-all duration-200 text-sm"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={3}
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-700 focus:border-transparent transition-all duration-200 resize-none text-sm"
                  placeholder="Escaliers, terrasses pilotis, balcons, meubles époxy, surface, délais..."
                />
              </div>
            </div>
            ...
            <Button
              ...
              className="w-full bg-slate-700 hover:bg-slate-600 text-white py-3 text-base font-semibold shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50"
            >
