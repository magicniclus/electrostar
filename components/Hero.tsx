...
export default function Hero({
  ...
  // Force image usage when backgroundImage is specified in config
  const shouldUseVideo = heroBackgroundVideo && !config?.backgroundImage;
              ...
              <Button
                ...
                className={`w-full py-3 text-white font-semibold rounded-lg transition-all duration-300 ${
                  isFormValid() && !isSubmitting
                    ? 'bg-slate-700 hover:bg-slate-600 shadow-lg hover:shadow-xl'
